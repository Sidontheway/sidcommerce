...
export default function GalleryVertical(props) {
  ...
  const images = [
    {
      imageSrc:props.product.image,
      imageThumbSrc:props.product.image,
      alt :'Image'
    },{
      imageSrc:props.product.image,
      imageThumbSrc:props.product.image,
  ...
  return (
    <div className="relative flex w-[50%] max-h-[600px] aspect-[4/3]">
      <SfScrollable
        ref={thumbsRef}
